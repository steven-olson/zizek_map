"""End-to-end ingest of *Absolute Recoil* — parses, classifies, sections, persists.

Run from the project root with:
    uv run python local_scripts/ingest_absolute_recoil.py
...
BOOK_GLOB = "Absolute Recoil*.epub"
