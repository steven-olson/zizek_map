"""End-to-end ingest of *Less Than Nothing* — parses, classifies, sections, persists.

Run from the project root with:
    uv run python local_scripts/ingest_less_than_nothing.py
...
BOOK_GLOB = "Less Than Nothing*.epub"
